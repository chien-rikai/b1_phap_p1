        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <h5>{{ __('common.order_status') }} : <span class="text-primary">{{ __('common.'.config('global.status_order.'.$order->status)) }}</span></h5>
                    <h5>{{ __('common.date_order') }} : {{ fortmatDateFrontend($order->created_at) }}</h5>
                    <h5>{{ __('common.date_order_end') }} : </h5>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="{{ route('site.member.history', $order->member->id) }}" class="btn btn-default">{{ __('common.back') }}</a>
                        </div>
                    </div>
                    <!-- /.card -->
                </div>
